...
public final class DrivetrainConstants {
    ...
    public static final DoubleEntry directionSlewNet = NetworkTableInstance.getDefault().getTable("Swerve").getDoubleTopic("DirectionalSlewRate").getEntry(directionSlewRate);
    public static final DoubleEntry magnitudeSlewNet = NetworkTableInstance.getDefault().getTable("Swerve").getDoubleTopic("MagnitudeSlewRate").getEntry(directionSlewRate);
    public static final DoubleEntry rotationSlewNet = NetworkTableInstance.getDefault().getTable("Swerve").getDoubleTopic("RotationSlewRate").getEntry(directionSlewRate);
